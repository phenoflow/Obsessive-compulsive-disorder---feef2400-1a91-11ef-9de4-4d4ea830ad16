...
(async () => {
  ...
  await fs.writeFile("obsessive-compulsive-disorder-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("obsessive-compulsive-disorder-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
